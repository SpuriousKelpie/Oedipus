function New-OedipusDataset1{
    <#
    .SYNOPSIS
        Returns a collection of objects for the Get-OedipusOutliers function.
    .DESCRIPTION
        ...
        the dataset for the Get-OedipusOutliers function.
    .PARAMETER Identity
        Specifies the Active Directory group object.
    .EXAMPLE
        New-OedipusDataset1 -Identity Executives_All_Staff
    .LINK
...
function New-OedipusDataset2{
    ...
    .PARAMETER Identity
        Specifies the Active Directory group object.
    .EXAMPLE
        New-OedipusDataset2 -Identity Executives_All_Staff
    .LINK
        https://github.com/SpuriousKelpie/Oedipus
    #>
...
function Get-OedipusOutliers{
    <#
    .SYNOPSIS
        Returns outlier objects from New-OedipusDataset input.
    .DESCRIPTION
    ...
    .EXAMPLE
        Get-OedipusOutliers -Objects (New-OedipusDataset1 -I $Identity | Sort -Property Counter)
        Get-OedipusOutliers -Objects (New-OedipusDataset2 -I $Identity | Sort -Property Counter)
    .LINK
        https://github.com/SpuriousKelpie/Oedipus
    #>
